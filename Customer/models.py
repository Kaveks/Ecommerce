...
# for security reasons use uuidfield which is a prolonged string hard to guess
    ...
    customer = models.ForeignKey(settings.AUTH_USER_MODEL, related_name=_(
        "customers"), verbose_name=_("Customer"), on_delete=models.CASCADE)
    first_name=models.CharField(max_length=255,help_text=_("required"),null=True)
    last_name=models.CharField(max_length=255,help_text=_("required"),null=True)
    ...
    address2 = models.CharField(
        _("Address2 optional"), max_length=255, blank=True, help_text=_('Optional '))
